...
- (UILabel *)contentLabel
{
    if (!_contentLabel)
    {
        ...
        [self.view insertSubview:_contentLabel aboveSubview:_topImageView];
        
        [_contentLabel mas_makeConstraints:^(MASConstraintMaker *make){
            make.top.equalTo(self.navigationView.mas_bottom).offset(10);
            make.left.equalTo(self.view.mas_left).offset(10);
            make.width.equalTo(@(App_Frame_Width - 20)).priorityLow();
...
- (UILabel *)subContentLabel
{
    if (!_subContentLabel)
    {
        ...
        _subContentLabel.textColor = [UIColor whiteColor];
        _subContentLabel.font = [UIFont systemFontOfSize:13];
        _subContentLabel.numberOfLines = 0;
         [self.view insertSubview:_subContentLabel aboveSubview:_topImageView];

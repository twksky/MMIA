...
- (UILabel *)sloganLabel
{
    if ( !_sloganLabel)
    {
        ...
        [_topImageView addSubview:_sloganLabel];
        
        [_sloganLabel mas_makeConstraints:^(MASConstraintMaker *make){
            
            make.top.mas_equalTo(_topImageView).offset(VIEW_OFFSET + 44 +18);
            make.left.mas_equalTo(_topImageView).offset(10);
            make.right.mas_equalTo(_topImageView).offset(-85);
...
- (UILabel *)descriptionLabel
{
    if (!_descriptionLabel)
    {
        ...
        [_topImageView addSubview:_descriptionLabel];
        
        [_descriptionLabel mas_makeConstraints:^(MASConstraintMaker *make){
            
            make.top.equalTo(_sloganLabel.mas_bottom).offset(5);
            make.left.right.equalTo(_sloganLabel);

                    ...
                    animated:(BOOL)animate
{
    ...
    if ( [viewController isKindOfClass:[MmiaDetailsCollectionViewController class]] )
    {
        MmiaDetailsCollectionViewController* detailVC = (MmiaDetailsCollectionViewController *)viewController;
...
//        [paperVC.view insertSubview:paperVC.navigationView aboveSubview:paperVC.topImageView];

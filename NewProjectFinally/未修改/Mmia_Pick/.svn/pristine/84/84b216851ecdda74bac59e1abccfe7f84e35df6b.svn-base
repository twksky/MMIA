...
- (void)reloadCellWithModel:(MmiaPaperProductListModel *)model
{
    ...
    CGFloat titleHeight = [GlobalFunction getTextSizeWithSystemFont:self.titleLabel.font ConstrainedToSize:CGSizeMake(self.width - 20, MAXFLOAT) string:model.title].height;

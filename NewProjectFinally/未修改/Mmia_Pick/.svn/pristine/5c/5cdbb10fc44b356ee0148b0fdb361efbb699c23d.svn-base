...
@property (strong, nonatomic) IBOutlet UILabel*     singelName;
@property (strong, nonatomic) IBOutlet UILabel*     singelDescription;

@property (strong, nonatomic) IBOutlet NSLayoutConstraint *nameTopSpace;
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *logoTopSpace;
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *logoImageViewHeight;

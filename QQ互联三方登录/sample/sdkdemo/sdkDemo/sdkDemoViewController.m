...
- (void)loadData
{
    ...
    [cellApiInfo addObject:[cellInfo info:@"QQ微博" target:nil Sel:@selector(pushSelectViewController:) viewController:nil userInfo:[NSNumber numberWithInteger:kApiQQT]]];

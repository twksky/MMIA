...
- (void)swipeView:(SwipeView *)swipeView willDisplayView:(UIView *)view forItemAtIndex:(NSUInteger)index;
- (void)swipeView:(SwipeView *)swipeView didDisplayView:(UIView *)view forItemAtIndex:(NSUInteger)index;

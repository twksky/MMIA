...
//- (UILabel *)collectionHeaderLabel
//{
//    if (!_collectionHeaderLabel)
//    {
//        _collectionHeaderLabel = [[UILabel alloc]init];
//        _collectionHeaderLabel.backgroundColor = [UIColor clearColor];
//        _collectionHeaderLabel.font = [UIFont systemFontOfSize:22];
//        _collectionHeaderLabel.text = @"推荐专题";
//        _collectionHeaderLabel.textAlignment = MMIATextAlignmentCenter;
//        _collectionHeaderLabel.textColor = ColorWithHexRGB(0xffffff);
//    }
//    return _collectionHeaderLabel;
//}

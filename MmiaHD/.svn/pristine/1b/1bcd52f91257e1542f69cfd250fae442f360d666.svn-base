...
+ (void)showWithText:(NSString *)text_
    ...
    [MmiaToast showWithText:text_ topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION image:imageStr_];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    MmiaToast *toast = [[MmiaToast alloc] initWithText:text_  image:imageStr_] ;
